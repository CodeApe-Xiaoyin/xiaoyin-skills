---
name: neat
description: "Sync project docs, memory, and handoff state for AI coding agents. Use for /neat, /neat checkpoint, /neat full, context checkpointing before /clear, and end-of-session documentation cleanup."
---
